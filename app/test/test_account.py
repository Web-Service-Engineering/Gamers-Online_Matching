...
def mocking_get_response(self, is_empty):
    if is_empty:
...
class TestAccount(BaseTestCase):
    def test_list_accounts_controller(self):
        expected_output = mocking_get_response(self, False)
        self.mock_get_account_list_controller.return_value = expected_output
        ...
        self.mock_get_account_list_controller.assert_called_once()

    def test_list_accounts_controller_empty(self):
        expected_output = mocking_get_response(self, True)
        self.mock_get_account_list_controller.return_value = expected_output
        expected_output_dict = json.loads(expected_output.data.decode('utf-8'))
    ...
    def test_register_account_controller_success(self):
        ...
        self.mock_save_account_controller.return_value = expected_output
        expected_output_dict = json.loads(expected_output.data.decode('utf-8'))
        ...
        self.mock_save_account_controller.assert_called_once()
